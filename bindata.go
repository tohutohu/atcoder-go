...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"main.go", "main_test.go"}}, map[string]*assets.File{
	"/main.go": &assets.File{
		Path:     "/main.go",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1520526724, 1520526724637657087),
		...
		Path:     "/",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1520530588, 1520530588898209995),
		Data:     nil,
	}}, "")
